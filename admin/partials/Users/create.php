    ...
    if($filter->checkMethod('POST')){
        ...
        if(!$token->validateToken($POST['_once'], 300)){
            ...
            if(isset($POST['createUser'])){
                ...
                $password  = $validator->match($POST['password'], $POST['passwordRepeat']) ? $POST['password']: $error['passwordMatch']  = 'Begge passwords skal udfyldes og være ens.'; 
                ...
                <div class="row">
                    ...
                    <div class="col s12 m6">
                        ...
                        <div class="input-field col s12"> 
                            ...
                            <?= isset($error['userRole']) ? '<p class="red-text text-ligthen-2">' . $error['userRole'] . '</p>' : ''?>
                        </div>
                        <div class="input-field col s12">  
